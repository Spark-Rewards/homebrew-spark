...
import (
	...
	"github.com/BrianBFarias/homebrew-spark/internal/config"
...
~/.spark/config.json is used.

Examples:
  spark use my-org/BusinessAPI
  spark use BusinessAPI                              # uses default org
  spark use git@github.com:my-org/BusinessAPI.git    # full URL`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err != nil {
			return fmt.Errorf("you must be inside a spark workspace — run 'spark create workspace <path>' first")
		}
