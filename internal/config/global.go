...
// GlobalConfigPath returns ~/.spark/config.json
...
// EnsureGlobalDir creates ~/.spark if it doesn't exist
...
// LoadGlobal reads the global config from ~/.spark/config.json
...
// SaveGlobal writes the global config to ~/.spark/config.json
